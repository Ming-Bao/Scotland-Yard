...
\begin{document}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Home server hosting
			\item Proxmox for virtualisation
			\item Docker for containerised deployment
			\item Cloudflare for secure external access
		\end{itemize}
	\end{itemize}
	...
	\begin{itemize}
		...
		\item Claude Code subscription (1 year, for code assistance) approved by supervisor: \$400
		\item Domain name for the website: \$10
		\item Google Maps API: free for the first 10,000 calls which should be enough; \$7 per additional 1,000 calls
	\end{itemize}
	...
	No additional ethical considerations are anticipated. Testing will be conducted primarily through software-based methods, and any user testing will be carried out with voluntary participation from students.
	...
	Intellectual property resulting from this project will be owned by the author, Mingzhe Bao. The university will retain permission to use the project materials for promotional purposes, such as Open Day events or advertising.
